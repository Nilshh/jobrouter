...
# Excel-Spalten
EXCEL_COLUMNS = ["Datum", "Plattform", "Titel", "Unternehmen", "Standort", "Link", "Beschreibung", "Salary_Min", "Salary_Max"]
...
SCRAPERS = {
    ...
    "indeed": {"enabled": True, "timeout": 30},
    "linkedin": {"enabled": True, "timeout": 30},
    "heise": {"enabled": False, "timeout": 15},
...
SCHEDULER_CONFIG = {
    "enabled": True,
    "scrape_times": ["08:00", "14:00", "20:00"],  # Uhrzeit für tägliches Scraping
...
EMAIL_CONFIG = {
    ...
    "sender_name": "Job Scraper",
    "digest_type": "daily",  # daily, weekly, never
    "min_jobs_to_notify": 1
}

# Salary-Einstellungen
SALARY_CONFIG = {
    "enabled": True,
    "min_range": 30000,
    "max_range": 250000,
