...
class JobwareScraper(BaseScraper):
    ...
    def _parse_jobs(self, html):
        ...
        try:
            ...
            if not job_listings:
                job_listings = soup.find_all("div", class_="searchResult")
            ...
            for item in job_listings:
                try:
                    ...
                    company_elem = item.find("span", class_="company") or item.find("div", class_="company") or item.find("a", class_="company")
                    ...
                    if link and not link.startswith("http"):
                        link = "https://www.jobware.de" + link
